...
from src.application.video.service.storage_service import AbstractVideoStorageService
...
async def upload_video(
    ...
    camera_id: UUID = Form(...),
    author_id: UUID = Form(...),
    storage_service: AbstractVideoStorageService = Depends(get_video_storage_service),
):
...
async def get_videos(
    ...
    video_service: AbstractVideoService = Depends(get_video_service)
):
