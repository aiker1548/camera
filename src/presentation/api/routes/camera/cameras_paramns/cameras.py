...
# from application.camera.interfaces.persistence.reader import CameraFilters
...
#     district_id__in: list[str] = Field(Query(default_factory=list, description="Фильтр по району"))
...
#             district_id__in=self.district_id__in,
#         )
